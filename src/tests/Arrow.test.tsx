...
test("against arrow snapshots", () => {
  let component = renderer.create(<Arrow faded={false} start={bottomLeft} end={topRight} />);

  let tree = component.toJSON();
  expect(tree).toMatchSnapshot();

  component = renderer.create(<Arrow faded={false} start={topLeft} end={bottomRight} />);
